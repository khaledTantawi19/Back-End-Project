...
<div class="row">
    ...
    <div class="col-4 d-flex justify-content-center">
        <div class="carousel w-75">
            <form method="get" action="{{ route('search.menu') }}">
                <input type="text" placeholder="Search" name="search" class="mt-4 rounded-pill search-bar w-75" />
                <div class="search-font">
                    <i class="fa fa-search gray" aria-hidden="true"></i>
                </div>
            </form>
        </div>
    </div>
...
<nav>
    <div class="row">
        <div class="col-4 logo d-flex justify-content-center">
            <p class="mt-3 mb-2 text-white">Cars</p>
        </div>
        <div id="links" class="col-8 d-flex justify-content-center">
            <a href="#" class="text-decoration-none px-3 mt-3 mb-2 text-white link active">Home</a>
            <a href="#" class="text-decoration-none px-3 mt-3 mb-2 text-white link">Mercedes</a>
            <a href="#" class="text-decoration-none px-3 mt-3 mb-2 text-white link">BMW</a>
            <a href="#" class="text-decoration-none px-3 mt-3 mb-2 text-white link">Sales</a>
            <a href="#" class="text-decoration-none px-3 mt-3 mb-2 text-white link">Blog</a>
        </div>
    </div>
</nav>
